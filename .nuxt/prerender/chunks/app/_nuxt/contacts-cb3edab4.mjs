...
import { useSSRContext, ref, computed, toRaw, unref, onMounted, mergeProps, withCtx, createVNode, openBlock, createBlock, createCommentVNode, toDisplayString, Fragment, renderList, createTextVNode, defineComponent, createElementBlock } from 'file:///Users/nikitamakovei/repos/tislogistic-frontend/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderClass, ssrRenderStyle, ssrRenderAttr } from 'file:///Users/nikitamakovei/repos/tislogistic-frontend/node_modules/vue/server-renderer/index.mjs';
...
import { _ as __nuxt_component_1 } from './DeliveryCalculator-e734ee29.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-01369665><section data-v-01369665><div class="bg white-theme-only gradient-bg" data-v-01369665></div>`);
      _push(ssrRenderComponent(_component_SharedBreadCrumbs, { class: "breadcrumbs" }, null, _parent));
      _push(`<h1 data-v-01369665>${ssrInterpolate(unref($texts).contacts)}</h1></section><section class="city-slider" data-v-01369665>`);
      if (unref(data)) {
      ...
      _push(`</section><section class="branch-info" data-v-01369665>`);
      if (unref(activeCity)) {
      ...
      if (unref(activeCity) && unref(activeCity).is_major_branch) {
        _push(`<section data-v-01369665><h2 data-v-01369665>${ssrInterpolate(unref($texts).companyAdministration)}</h2>`);
        ...
        _push(`<section class="administration" data-v-01369665>`);
      ...
      _push(`<section data-v-01369665>`);
      _push(ssrRenderComponent(_component_ContactsTelegramChannel, null, null, _parent));
      _push(`</section><section data-v-01369665><div class="calculator__back-blur" data-v-01369665>`);
...
const contacts = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-01369665"]]);

export { contacts as default };
//# sourceMappingURL=contacts-cb3edab4.mjs.map
