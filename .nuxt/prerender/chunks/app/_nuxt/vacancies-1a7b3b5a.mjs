...
import { useSSRContext, unref, mergeProps, ref, computed, toRaw, withCtx, createVNode, openBlock, createBlock, Fragment, renderList, reactive, createTextVNode } from 'file:///Users/nikitamakovei/repos/tislogistic-frontend/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderStyle, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderAttr, ssrGetDirectiveProps, ssrGetDynamicModelProps, ssrRenderClass } from 'file:///Users/nikitamakovei/repos/tislogistic-frontend/node_modules/vue/server-renderer/index.mjs';
...
import { Swiper, SwiperSlide } from 'file:///Users/nikitamakovei/repos/tislogistic-frontend/node_modules/swiper/vue/swiper-vue.js';
...
const _sfc_main$5 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-5a39c0e1><h2 data-v-5a39c0e1>${ssrInterpolate(_ctx.$texts.openVacancies)}</h2>`);
      if (unref(data)) {
              ...
              ssrRenderList(unref(activeCity).vacancies, (item, i) => {
                _push2(ssrRenderComponent(_component_SwiperSlide, {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<div class="slide-content" data-v-5a39c0e1${_scopeId2}>`);
...
const __nuxt_component_2$1 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-5a39c0e1"]]);
const _sfc_main$4 = {};
...
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-9d8ece9b"]]);
const _sfc_main = {
  __name: "vacancies",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-538b95e3><section data-v-538b95e3><div style="${ssrRenderStyle(bgImg)}" class="bg vacancies-bg" data-v-538b95e3></div><div data-v-538b95e3>`);
      _push(ssrRenderComponent(_component_SharedBreadCrumbs, null, null, _parent));
      _push(`<h1 data-v-538b95e3>${ssrInterpolate(unref($texts).vacancies)}</h1><p data-v-538b95e3> \u041F\u0440\u0438\u0441\u043E\u0435\u0434\u0438\u043D\u044F\u0439\u0441\u044F <span data-v-538b95e3>\u043A \u043A\u043E\u043C\u0430\u043D\u0434\u0435 \u043F\u0440\u043E\u0444\u0435\u0441\u0441\u0438\u043E\u043D\u0430\u043B\u043E\u0432 </span><strong data-v-538b95e3>\u0422\u0418\u0421 \u041B\u041E\u0414\u0416\u0418\u0421\u0422\u0418\u041A</strong></p></div></section><section data-v-538b95e3>`);
      _push(ssrRenderComponent(_component_VacanciesWhyUs, null, null, _parent));
      _push(`</section><section data-v-538b95e3>`);
      _push(ssrRenderComponent(_component_VacanciesOpenPositions, null, null, _parent));
      _push(`</section><section data-v-538b95e3><div class="banner" data-v-538b95e3><strong data-v-538b95e3>${ssrInterpolate(unref($texts).vacanciesBanner1)} <span data-v-538b95e3>${ssrInterpolate(unref($texts).vacanciesBanner2)}</span></strong></div></section><section data-v-538b95e3>`);
...
const vacancies = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-538b95e3"]]);

export { vacancies as default };
//# sourceMappingURL=vacancies-1a7b3b5a.mjs.map
