...
import { useSSRContext, mergeProps, withCtx, createTextVNode, resolveDirective } from 'file:///Users/nikitamakovei/repos/tislogistic-frontend/node_modules/vue/index.mjs';
import { vMaska } from 'file:///Users/nikitamakovei/repos/tislogistic-frontend/node_modules/maska/dist/maska.js';
import { ssrRenderAttrs, ssrInterpolate, ssrRenderComponent, ssrRenderClass, ssrRenderAttr, ssrRenderList, ssrGetDirectiveProps } from 'file:///Users/nikitamakovei/repos/tislogistic-frontend/node_modules/vue/server-renderer/index.mjs';
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "calculator__input-container select_container" }, _attrs))} data-v-f4cdbe58><div class="${ssrRenderClass([{ gray: !$props.formData.city_id }, "calculator__select"])}" data-v-f4cdbe58>${ssrInterpolate($options.cityChosen)} <img${ssrRenderAttr("src", _imports_0$1)} class="${ssrRenderClass({ rotated: $data.cityOptionsShown })}" alt="" data-v-f4cdbe58>`);
  if ($data.cityOptionsShown) {
    _push(`<ul class="calculator__options" data-v-f4cdbe58><!--[-->`);
    ssrRenderList($options.citiesIDs, (cityID, key) => {
      _push(`<li data-v-f4cdbe58>${ssrInterpolate($options.cities[cityID])}</li>`);
    });
    _push(`<!--]--></ul>`);
  } else {
    _push(`<!---->`);
  }
  _push(`</div><label class="calculator__input-label" data-v-f4cdbe58>\u0424\u0438\u043B\u0438\u0430\u043B</label>`);
  if ($props.invalidInputMessages.city_id) {
    _push(`<div class="calculator__error-message" data-v-f4cdbe58>${ssrInterpolate($props.invalidInputMessages.city_id)}</div>`);
  } else {
    _push(`<!---->`);
  }
  _push(`</div>`);
...
const __nuxt_component_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$3], ["__scopeId", "data-v-f4cdbe58"]]);
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "calculator__input-container" }, _attrs))} data-v-211b6d59>`);
  if ($props.inputName === "description") {
    _push(`<img${ssrRenderAttr("src", _imports_0)} class="calculator__info_icon"${ssrRenderAttr("alt", _ctx.$texts.additionalInfo)} data-v-211b6d59>`);
  } else {
    _push(`<!---->`);
  }
  if ($props.inputName === "description") {
    _push(`<div class="calculator__description-message" data-v-211b6d59>${ssrInterpolate(_ctx.$texts.descriptionInputMessage)}</div>`);
  } else {
    _push(`<!---->`);
  }
  if ($props.inputName === "phone") {
    ...
    }, ssrGetDirectiveProps(_ctx, _directive_maska)))} data-v-211b6d59>`);
  } else {
    _push(`<input${ssrRenderAttr("type", $props.inputName === "email" ? "email" : "text")} class="calculator__input"${ssrRenderAttr("placeholder", _ctx.$texts[$props.inputName])}${ssrRenderAttr("value", $props.formData[$props.inputName])} data-v-211b6d59>`);
  }
  _push(`<label class="calculator__input-label" data-v-211b6d59>${ssrInterpolate(_ctx.$texts[$props.inputName])}</label>`);
  if ($props.invalidInputMessages[$props.inputName]) {
    _push(`<div class="calculator__error-message" data-v-211b6d59>${ssrInterpolate($props.invalidInputMessages[$props.inputName])}</div>`);
  } else {
    _push(`<!---->`);
  }
  _push(`</div>`);
...
const __nuxt_component_1$1 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$2], ["__scopeId", "data-v-211b6d59"]]);
const _sfc_main$1 = {
  directives: { maska: vMaska },
  props: {
    handleSubmit: {
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "calculator__body" }, _attrs))} data-v-25fd4c89><div class="calculator__second-desktop-layout-container" data-v-25fd4c89>`);
  ...
  _push(`<div class="calculator__email-container" data-v-25fd4c89>`);
  _push(ssrRenderComponent(_component_SharedCalculatorInput, {
    class: "shrink",
    "form-data": $props.formData,
    "invalid-input-messages": $props.invalidInputMessages,
  ...
  _push(`<p class="calculator__email-note" data-v-25fd4c89>${ssrInterpolate(_ctx.$texts.calculatorEmailNote)}</p></div></div><div class="calculator__bottom" data-v-25fd4c89><div class="calculator__send-container" data-v-25fd4c89><button class="calculator__button animate-red" data-v-25fd4c89>${ssrInterpolate(_ctx.$texts.send)}</button><div class="calculator__confidentiality" data-v-25fd4c89> \u041D\u0430\u0436\u0438\u043C\u0430\u044F \u043A\u043D\u043E\u043F\u043A\u0443 <span data-v-25fd4c89>\xAB\u041E\u0442\u043F\u0440\u0430\u0432\u0438\u0442\u044C\xBB</span>, \u0412\u044B \u043F\u0440\u0438\u043D\u0438\u043C\u0430\u0435\u0442\u0435 \u0443\u0441\u043B\u043E\u0432\u0438\u044F `);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-25fd4c89"]]);
const _sfc_main = {
  setup() {
...
//# sourceMappingURL=DeliveryCalculator-e734ee29.mjs.map
