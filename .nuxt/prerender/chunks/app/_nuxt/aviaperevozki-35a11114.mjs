...
import { useSSRContext, mergeProps, unref } from 'file:///Users/nikitamakovei/repos/tislogistic-frontend/node_modules/vue/index.mjs';
import { u as useImage } from './composables-5d51eb10.mjs';
import { ssrRenderAttrs, ssrRenderStyle, ssrRenderAttr, ssrRenderComponent, ssrInterpolate, ssrRenderList } from 'file:///Users/nikitamakovei/repos/tislogistic-frontend/node_modules/vue/server-renderer/index.mjs';
import { _ as __nuxt_component_0$2 } from './nuxt-img-6da1c54a.mjs';
import { _ as __nuxt_component_0$3 } from './CardsItem-11652c8d.mjs';
import { _ as __nuxt_component_4 } from './ServicesFiller-ebdf8e5e.mjs';
...
import './DeliveryCalculator-e734ee29.mjs';
import '../../renderer.mjs';
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "card" }, _attrs))} data-v-37fb15d5><div class="card__img-container" style="${ssrRenderStyle($options.bg)}"${ssrRenderAttr("title", $options.seoAlt)}${ssrRenderAttr("aria-label", $options.seoAlt)} data-v-37fb15d5></div><div class="card__info" data-v-37fb15d5><h3 data-v-37fb15d5>${ssrInterpolate($props.data.title)}</h3><p data-v-37fb15d5>${ssrInterpolate($props.data.text)}</p>`);
  if ($props.data.legal) {
    _push(`<p class="legal" data-v-37fb15d5>${ssrInterpolate($props.data.legal)}</p>`);
  } else {
    _push(`<!---->`);
  }
  _push(`</div></div>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-37fb15d5"]]);
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<main${ssrRenderAttrs(_attrs)} data-v-4b493b7c><section data-v-4b493b7c><div style="${ssrRenderStyle($options.background)}" class="bg air-freight-bg"${ssrRenderAttr("title", $options.seoAlt)}${ssrRenderAttr("aria-label", $options.seoAlt)} data-v-4b493b7c></div>`);
  _push(ssrRenderComponent(_component_SharedServicesHeader, {
    title: _ctx.$texts.airFreight,
    subtitle: _ctx.$texts.airFreightNote,
    class: "_air"
  }, null, _parent));
  _push(`</section><section id="scroll-target" data-v-4b493b7c>`);
  _push(ssrRenderComponent(_component_AviaperevozkiAirTypes, null, null, _parent));
  _push(`</section><section data-v-4b493b7c>`);
...
const aviaperevozki = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-4b493b7c"]]);

export { aviaperevozki as default };
//# sourceMappingURL=aviaperevozki-35a11114.mjs.map
