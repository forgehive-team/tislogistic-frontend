...
import { useSSRContext, defineComponent, computed, mergeProps, unref, withCtx, createVNode, reactive, createTextVNode, toDisplayString, resolveComponent, openBlock, createBlock, Fragment, renderList } from 'file:///Users/nikitamakovei/repos/tislogistic-frontend/node_modules/vue/index.mjs';
import { t as titleCase, u as useServerHead, c as createInternalLinkResolver, r as resolveAbsoluteInternalLink } from './internalLinks-dc4e1b80.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrIncludeBooleanAttr, ssrRenderSlot, ssrLooseContain, ssrRenderAttr, ssrRenderClass, ssrInterpolate, ssrRenderList } from 'file:///Users/nikitamakovei/repos/tislogistic-frontend/node_modules/vue/server-renderer/index.mjs';
...
import { Collapse } from 'file:///Users/nikitamakovei/repos/tislogistic-frontend/node_modules/vue-collapsed/dist/index.js';
import { s as servicesList } from './servicesList-d8a4a1b3.mjs';
import { _ as __nuxt_component_0$2, a as __nuxt_component_0$1$1 } from './ReturnCallForm-aea0d31d.mjs';
import { _ as __nuxt_component_1$2 } from './DeliveryCalculator-e734ee29.mjs';
...
import 'file:///Users/nikitamakovei/repos/tislogistic-frontend/node_modules/maska/dist/maska.js';
...
function _sfc_ssrRender$7(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<aside${ssrRenderAttrs(mergeProps({ class: "sidebar mobile-tablet-only" }, _attrs))} data-v-6328f3e5><div class="sidebar__container" data-v-6328f3e5><div class="sidebar__top" data-v-6328f3e5>`);
  ...
  _push(`<button class="sidebar__close" data-v-6328f3e5><img${ssrRenderAttr("src", _imports_0$2)}${ssrRenderAttr("alt", _ctx.$texts.close)} data-v-6328f3e5></button></div><div class="sidebar__theme-container" data-v-6328f3e5>`);
  ...
  _push(`</div><div class="sidebar__contacts" data-v-6328f3e5><a${ssrRenderAttr("href", `tel:${_ctx.$texts.companyPhone}`)} data-v-6328f3e5>`);
  _push(ssrRenderComponent(_component_IconsPhoneIcon, null, null, _parent));
  _push(` ${ssrInterpolate(_ctx.$texts.companyPhone)}</a></div><div class="sidebar__buttons" data-v-6328f3e5><button class="navbar__btn navbar__btn_red sidebar__btn" data-v-6328f3e5>${ssrInterpolate(_ctx.$texts.calculateDelivery)}</button><button class="navbar__btn sidebar__btn" data-v-6328f3e5>${ssrInterpolate(_ctx.$texts.returnCall)}</button></div><div class="sidebar__links" data-v-6328f3e5>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: "/about",
    class: "sidebar__link",
    onClick: $props.toggleSidebar
  ...
  _push(`<div data-v-6328f3e5><div class="sidebar__services-link" data-v-6328f3e5>`);
  ...
  _push(ssrRenderComponent(_component_Collapse, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="sidebar__services-list" data-v-6328f3e5${_scopeId}><!--[-->`);
  ...
  _push(`<!--]--></div><div class="sidebar__links sidebar__links_secondary" data-v-6328f3e5><a href="/traffic" class="vessels" data-v-6328f3e5>${ssrInterpolate(_ctx.$texts.vesselsPosition)}</a><!--[-->`);
...
const __nuxt_component_4$1 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["ssrRender", _sfc_ssrRender$7], ["__scopeId", "data-v-6328f3e5"]]);
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_NuxtLink = __nuxt_component_0$1;
  const _component_IconsCompanyLogo = __nuxt_component_1$3;
  _push(`<footer${ssrRenderAttrs(mergeProps({ class: "footer" }, _attrs))} data-v-4a863d90><div class="footer__container" data-v-4a863d90>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(`<img${ssrRenderAttr("src", _imports_0)}${ssrRenderAttr("alt", _ctx.$texts.companyNameSeo)} data-v-4a863d90${_scopeId}>`);
      } else {
        return [
          createVNode(_component_IconsCompanyLogo),
          createVNode("img", {
  ...
  _push(`<div class="footer__nav-links" data-v-4a863d90><!--[-->`);
  ...
  _push(`<!--]--></div><div class="footer__info footer__info_left" data-v-4a863d90><!--[-->`);
  ...
  _push(`<!--]--><a href="/traffic" class="vessels" data-v-4a863d90>${ssrInterpolate(_ctx.$texts.vesselsPosition)}</a></div><div class="footer__info footer__info_right" data-v-4a863d90><!--[-->`);
  ...
  _push(`<!--]--></div><div class="footer__branch-info phone-block" data-v-4a863d90><span data-v-4a863d90>${ssrInterpolate(_ctx.$texts.phone)}</span><a${ssrRenderAttr("href", $options.phoneRef)} data-v-4a863d90>${ssrInterpolate(_ctx.$texts.companyPhone)}</a></div><div class="desktop-placeholder" data-v-4a863d90></div><img class="footer__bg"${ssrRenderAttr("src", _imports_1)} alt="" data-v-4a863d90></div><div class="footer__bottom" data-v-4a863d90>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
  ...
  _push(`<div class="placeholder" data-v-4a863d90></div>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    class: "agreement",
    to: "/eula"
  }, {
  ...
  _push(`<span class="copyright" data-v-4a863d90>${ssrInterpolate(_ctx.$texts.footerNote)}</span></div></footer>`);
}
...
const __nuxt_component_5 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-4a863d90"]]);
const _sfc_main = {
  setup() {
    const isWhiteTheme = useTheme();
    useHead({
...
//# sourceMappingURL=default-266f7870.mjs.map
