...
import { withCtx, createTextVNode, toDisplayString, useSSRContext } from 'file:///Users/nikitamakovei/repos/tislogistic-frontend/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrInterpolate, ssrRenderAttr } from 'file:///Users/nikitamakovei/repos/tislogistic-frontend/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-ef95c6d1><section data-v-ef95c6d1><div class="bg white-theme-only gradient-bg" data-v-ef95c6d1></div><div data-v-ef95c6d1>`);
      _push(ssrRenderComponent(_component_SharedBreadCrumbs, { class: "breadcrumbs" }, null, _parent));
      _push(`<h1 data-v-ef95c6d1>\u041A\u0430\u0440\u0442\u0430 \u0441\u0430\u0439\u0442\u0430</h1><div class="sitemap" data-v-ef95c6d1><!--[-->`);
      ssrRenderList(routesList, (sitemap2, i) => {
        _push(`<div data-v-ef95c6d1><!--[-->`);
        ssrRenderList(sitemap2, (route) => {
          _push(`<ul data-v-ef95c6d1><li data-v-ef95c6d1>`);
          if (!route.client) {
            ...
            _push(`<a${ssrRenderAttr("href", route.url)} data-v-ef95c6d1>${ssrInterpolate(route.label)}</a>`);
          }
          if (route.subroutes.length) {
            _push(`<ul class="subroutes" data-v-ef95c6d1><!--[-->`);
            ssrRenderList(route.subroutes, (subroute) => {
              _push(`<li data-v-ef95c6d1>`);
              _push(ssrRenderComponent(_component_NuxtLink, {
                to: subroute.url
              }, {
                default: withCtx((_, _push2, _parent2, _scopeId) => {
...
const sitemap = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ef95c6d1"]]);

export { sitemap as default };
//# sourceMappingURL=sitemap-56b4ea58.mjs.map
