import { _ as __nuxt_component_0$3 } from "./BreadCrumbs-7a67b271.js";
import { Swiper, SwiperSlide } from "swiper/vue";
import { _ as __nuxt_component_3$1 } from "./SwiperControls-e2965511.js";
import { _ as __nuxt_component_0$1 } from "./FullScreenImg-6689124a.js";
import { ref, mergeProps, withCtx, createVNode, openBlock, createBlock, Fragment, renderList, unref, useSSRContext } from "vue";
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrRenderAttr, ssrInterpolate } from "vue/server-renderer";
import { _ as _export_sfc, u as useNuxtApp } from "../server.mjs";
import { _ as __nuxt_component_0$2 } from "./ProjectsItem-93537194.js";
import { t as transformDate } from "./transformDate-3029d144.js";
import { u as useCalculatorPopup, b as useReturnCallModal } from "./state-06d22502.js";
import "destr";
import { _ as _imports_0 } from "./expand-29e2e84d.js";
const ContainersSwiper_scss_vue_type_style_index_0_src_338d56bf_scoped_338d56bf_lang = "";
const _sfc_main$3 = {
  __name: "ImagesSwiper",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_SharedFullScreenImg = __nuxt_component_0$1;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "containers-swiper" }, _attrs))} data-v-338d56bf>`);
              ...
              ssrRenderList(props.imgList, (img, i) => {
                _push2(ssrRenderComponent(_component_SwiperSlide, {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<div class="slide-img-container" data-v-338d56bf${_scopeId2}><img${ssrRenderAttr("src", img)} data-v-338d56bf${_scopeId2}></div>`);
                    } else {
                      return [
                        createVNode("div", {
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-338d56bf"]]);
const NewsPage_scss_vue_type_style_index_0_src_a9fb9aef_scoped_a9fb9aef_lang = "";
const _sfc_main$2 = {
  __name: "StaticImages",
  __ssrInlineRender: true,
  props: ["images"],
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_SharedFullScreenImg = __nuxt_component_0$1;
      _push(`<!--[--><div class="news__static-pictures" data-v-a9fb9aef><!--[-->`);
      ssrRenderList(props.images, (imgSrc, i) => {
        _push(`<div class="news__bottom-img-container" data-v-a9fb9aef><img${ssrRenderAttr("src", imgSrc)} data-v-a9fb9aef></div>`);
      });
      _push(`<!--]--></div>`);
      if (unref(fullScreenImgSrc)) {
        _push(ssrRenderComponent(_component_SharedFullScreenImg, {
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-a9fb9aef"]]);
const OtherItems_scss_vue_type_style_index_0_src_3fdcb84e_scoped_3fdcb84e_lang = "";
const __default__ = {
  props: {
    itemsList: {
      type: Array,
...
const _sfc_main$1 = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _component_HomeProjectsItem = __nuxt_component_0$2;
...
const NewsPage_scss_vue_type_style_index_0_src_true_lang = "";
const _sfc_main = {
  props: {
    data: {
      type: Object,
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_SharedBreadCrumbs = __nuxt_component_0$3;
  ...
  if ($props.data.other_items.length) {
    ...
    _push(ssrRenderComponent(_component_NewsOtherItems, {
      "items-list": $props.data.other_items,
...
//# sourceMappingURL=NewsPage-1b1383d3.js.map
