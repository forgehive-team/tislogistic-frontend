...
const ForeignServices_scss_vue_type_style_index_0_src_b5a2e9a1_scoped_b5a2e9a1_lang = "";
const _sfc_main$a = {
...
const list = [
  ...
  {
    label: "Полную таможенную очистку, как в стране отправителя, так и в стране получателя ",
...
const InternationalTrade_scss_vue_type_style_index_0_src_d41a53d5_scoped_d41a53d5_lang = "";
const _sfc_main$9 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _component_nuxt_img = __nuxt_component_0$1;
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-d41a53d5><h2 data-v-d41a53d5>${ssrInterpolate(_ctx.$texts.internationalTradeTitle)}</h2><div class="grid" data-v-d41a53d5><!--[-->`);
      ssrRenderList(unref(list), (item, i) => {
        _push(`<div class="item" data-v-d41a53d5>`);
        _push(ssrRenderComponent(_component_nuxt_img, {
          src: item.img,
          alt: "",
          class: "icon-gray"
        }, null, _parent));
        _push(`<p data-v-d41a53d5>${ssrInterpolate(item.label)}</p></div>`);
      });
      _push(`<!--]--></div><p class="footnote" data-v-d41a53d5>${ssrInterpolate(_ctx.$texts.parallelImportDef)}</p><p class="footnote footnote_second" data-v-d41a53d5>${ssrInterpolate(_ctx.$texts.from500Kilos)}</p></div>`);
    };
  }
};
...
const __nuxt_component_2$1 = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-d41a53d5"]]);
const _sfc_main$8 = {};
...
const CooperationResult_scss_vue_type_style_index_0_src_8f9ca320_scoped_8f9ca320_lang = "";
const _sfc_main$1 = {};
...
const ForeignActivity_scss_vue_type_style_index_0_src_76389068_scoped_76389068_lang = "";
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-76389068><section data-v-76389068><div style="${ssrRenderStyle(bgImg)}" class="bg foreign-bg" data-v-76389068></div>`);
      ...
      _push(`</section><section id="scroll-target" data-v-76389068>`);
      _push(ssrRenderComponent(_component_ForeignServices, null, null, _parent));
      _push(`</section><section data-v-76389068>`);
...
const vneshneekonomicheskayaDeyatelnost = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-76389068"]]);
export {
  vneshneekonomicheskayaDeyatelnost as default
};
//# sourceMappingURL=vneshneekonomicheskaya-deyatelnost-4083a05a.js.map
