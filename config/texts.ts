export const texts = {
    ...
    seoKeywords:
        'логистика, грузоперевозки, международная логистика, таможенное оформление, складские услуги, транспортно-логистические решения, контейнерные перевозки, автоперевозки, железнодорожные перевозки, мультимодальные перевозки, интеграция логистических процессов, проектная логистика, технологии и инновации в логистике, безопасность грузовых перевозок, качество услуг, оперативность и надежность, клиентоориентированность, хранение грузов, сопровождение грузоперевозок, экспедирование грузов, Таможенное оформление, Морские грузоперевозки, Железнодорожные грузоперевозки, Автомобильные перевозки, Аренда контейнеров с доставкой, Экспедирование грузов, Грузоперевозки из Владивостока, Грузоперевозки по России, Доставка груза из Китая, Доставка груза из Кореи, Доставка груза из Японии, Внешнеэкономическая деятельность, параллельный импорт, импортозамещение, Таможенное оформление товаров народного потребления, таможенное оформление грузовых автомобилей, таможенное оформление спецтехники, растаможка экскаватора, растаможка буровой установки, перевозка генеральных грузов, перевозка негабаритных грузов, перевозка спецтехники из Китая, перевозка строительной техники из Китая, закуп товара в Китае, поиска и закуп товаров на Алибабе, поставка товаров из Китая под заказ, поставка санкционного оборудования в Россию, лислоджистик, лис лоджистик, Tis Logistic, TisLogistic',
    ...
    seaFreightSeoDescription:
        'В случае удаленности пункта доставки и необходимости комбинировать грузоперевозки «Тис Лоджистик» рекомендует использовать транспортировку морем. А уже в зависимости от пункта назначения мы предлагаем каботажные и международные перевозки',
    ...
    collapse: 'Свернуть',
    trainFreightSeoDescription:
        'Железнодорожные грузоперевозки — основная транспортная артерия в России. Доставим Ваш груз из точки, А в точку Б. За время существования мы создали развитую систему контейнерных и вагонных перевозок по России любых видов груза с возможностью обеспечения охраны по пути следования',
