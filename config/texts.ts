...
export const texts = {
    ...
    trainFreight: 'Железнодорожные перевозки ',
    ...
    seoDescription:
        'TIS Logistic - транспортно-экспедиторская компания логистических услуг в России и за рубежом. Международная логистика, таможенное оформление, перевозки и складские услуги по выгодным ценам.',
    ...
    ourGoal: 'наша цель!',
    seaFreightNote:
        'В случае удалённости пункта доставки и необходимости комбинировать перевозки «ТИС ЛОДЖИСТИК» рекомендует использовать транспортировку морем. А уже в зависимости от пункта назначения мы предлагаем каботажные и международные перевозки.',
    ...
    seoTerminalServicesDescription:
        'Международные морские перевозки, доставка в Россию из Китая, Японии, США, Кореи, Европы и других направлений, каботажные перевозки по России',
    seoTerminalServicesKeywords:
        'доставка морем, морские перевозки, международные морские перевозки, доставка из Китая, Япония, Корея, доставка из США, Европа, ОАЭ, каботажные, каботажные перевозки, чукотка, сахалин, камчатка, ',
    ...
    internationalSeaFreight: 'Международные морские перевозки ',
    ...
    coastalShipping: 'Каботажные морские перевозки',
    coastalShippingNote:
    ...
    // seo metas:
    seoKeywordsBase:
        'тис лоджистик, tis logistic, tis logistics, тис лоджистик владивосток, тис логистика, логистические услуги, логистика, перевозки, международная логистика, международные перевозки, доставка, международная доствка, перевозки, международная доставка грузов, тис-лоджистик, расчет стоимости логистических услуг, рассчитать стоимость доставки, стоимость грузоперевозок, ооо тис лоджистик, 2023, перевозки «под ключ», организация логистики, ',
    seoServicesKeywordsBase:
        'таможенное оформление, растаможка, морские перевозки, железнодорожные перевозки, ж/д перевозки, жд перевозки, автомобильные перевозки, авиаперевозки, проектная логистика, складские услуги, экспедирование грузов, страхование грузов, сертификация продукции, ',
    ...
    seoServicesDescription:
        'Международные перевозки, логистика по России, из Китая. Морские, железнодорожные, автомобильные и авиаперевозки, таможенное оформление и другие услуги',
    seoServicesKeywords:
    ...
    seoProjectLogisticsKeywords:
        'проектная логистика, проектные перевозки, перевозка грузов, сверхгабаритных, тяжеловесных, негабаритных, крупногабаритных, длинномерных, опасных, перевозка оборудования, перевозка промышленного оборудования, перевозка транспорта, доставка из Японии, доставка в условиях санкций, ',
    ...
    aboutSubtitle:
        'Основная деятельность компании — международные (мультимодальные) перевозки из любой страны мира в любой город России «под ключ», включая закуп товара у поставщиков, комплексную логистику до Вашего склада, таможенное оформление, сертификационные услуги и профессиональные складские услуги.',
    companyDescription:
    ...
    info: 'Информация',
    attention: 'Внимание!',
    confirmSending: 'Подтвердить отправку',
    cancel: 'Отмена',
    weDontShip:
