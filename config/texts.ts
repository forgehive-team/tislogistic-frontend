export const texts = {
    oldDomain: 'https://tislogistic.ru',
    ...
    seoDescription:
        'TIS Logistic - транспортно-экспедиторская компания логистических услуг в России и за рубежом. Международная логистика, таможенное оформление, грузоперевозки и складские услуги по выгодным ценам. Закажите консультацию и расчет уже сегодня!',
    seoTitleMain:
        'Логистические услуги от транспортно-экспедиторской компании TIS Logistic',
    seoTitleContainers:
