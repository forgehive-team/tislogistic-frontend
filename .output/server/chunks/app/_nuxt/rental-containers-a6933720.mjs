...
import { _ as __nuxt_component_0$1 } from './ReturnCallForm-d086548f.mjs';
import { _ as __nuxt_component_3 } from './KeyIndicators-c056b723.mjs';
...
import { _ as __nuxt_component_1$1 } from './ServicesLinks-b725e6d3.mjs';
...
const containersStatsLabels = [
  ...
  {
    label: "Number of pallets, Euro",
    key: "palletsEuro"
  },
  {
    label: "Number of pallets, standard",
    key: "palletsStandard"
  }
];
const containersStatsValues = [
  {
    ...
    payload: "28 360 \u043A\u0433",
    doorsWidth: "2 336 mm",
    doorsHeight: "2 291 mm",
    palletsEuro: "11 pcs",
    palletsStandard: "9 pcs",
  ...
  },
  {
    ...
    payload: "27 790 \u043A\u0433",
    doorsWidth: "2 400 mm",
    doorsHeight: "2 585 mm",
    palletsEuro: "14 pcs",
    palletsStandard: "11 pcs",
    img: "container_small.jpg",
    price: "12 000 \u20BD"
  },
  {
    ...
    payload: "28 800 \u043A\u0433",
    doorsWidth: "2 340 mm",
    doorsHeight: "2 285 mm",
    palletsEuro: "24 pcs",
    palletsStandard: "21 pcs",
  ...
  },
  {
    ...
    payload: "29 600 \u043A\u0433",
    doorsWidth: "2 396 mm",
    doorsHeight: "2 584 mm",
    palletsEuro: "30 pcs",
    palletsStandard: "24 pcs",
    img: "container_large.jpg",
    price: "18 000 \u20BD"
  }
];
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "containers-swiper" }, _attrs))} data-v-7bc935b2><h2 data-v-7bc935b2>${ssrInterpolate(_ctx.$texts.rentalContainersSwiperTitle)}</h2>`);
          ...
          ssrRenderList($options.imgList, (img, i) => {
            _push2(ssrRenderComponent(_component_SwiperSlide, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="slide-img-container" data-v-7bc935b2${_scopeId2}>`);
...
const __nuxt_component_4 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-7bc935b2"]]);
const _sfc_main = {
  setup() {
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_SharedKeyIndicators = __nuxt_component_3;
  ...
  _push(`<main${ssrRenderAttrs(_attrs)} data-v-950e0107><section data-v-950e0107><div style="${ssrRenderStyle($options.background)}" class="bg rent-bg" data-v-950e0107></div>`);
  _push(ssrRenderComponent(_component_ArendaKonteynerovMainHeader, null, null, _parent));
  _push(`</section><section data-v-950e0107>`);
  _push(ssrRenderComponent(_component_ArendaKonteynerovContainersStats, null, null, _parent));
  _push(`</section><section class="form-section" data-v-950e0107>`);
  ...
  _push(`</section><section class="projects-section" data-v-950e0107><div style="${ssrRenderStyle($options.bottomBackground)}" class="bg bottom-bg" data-v-950e0107></div>`);
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/services/rental-containers.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const rentalContainers = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-950e0107"]]);

export { rentalContainers as default };
//# sourceMappingURL=rental-containers-a6933720.mjs.map
