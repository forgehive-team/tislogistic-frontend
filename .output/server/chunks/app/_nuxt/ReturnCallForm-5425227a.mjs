import { useSSRContext, resolveDirective, mergeProps, withCtx, createTextVNode, createVNode } from 'vue';
  ...
  computed: {
    services() {
      return this.rentalContainers ? {
        ...
        29: "\u041C\u0443\u043B\u044C\u0442\u0438\u043C\u043E\u0434\u0430\u043B\u044C\u043D\u044B\u0435 \u043F\u0435\u0440\u0435\u0432\u043E\u0437\u043A\u0438",
        30: "\u0422\u0435\u0440\u043C\u0438\u043D\u0430\u043B\u044C\u043D\u044B\u0435 \u0443\u0441\u043B\u0443\u0433\u0438",
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "return-call" }, _attrs))} data-v-e15092f0>`);
  if ($props.modal) {
    _push(`<button class="return-call__close" data-v-e15092f0>`);
  ...
  _push(`<h3 data-v-e15092f0>${ssrInterpolate($props.title)}</h3><h5 data-v-e15092f0>${ssrInterpolate(_ctx.$texts.willCall)}</h5><div class="return-call__fields" data-v-e15092f0><div class="return-call__field" data-v-e15092f0><div class="${ssrRenderClass([{ gray: !$data.formData.service_id }, "return-call__input"])}" data-v-e15092f0>${ssrInterpolate($options.serviceChosen)} <img${ssrRenderAttr("src", _imports_0)} class="${ssrRenderClass({ rotated: $data.serviceOptionsShown })}" alt="" data-v-e15092f0><ul class="${ssrRenderClass([{ options_shown: $data.serviceOptionsShown }, "return-call__options"])}" data-v-e15092f0><!--[-->`);
  ssrRenderList($options.servicesIDs, (serviceID, key) => {
    _push(`<li data-v-e15092f0>${ssrInterpolate($options.services[serviceID])}</li>`);
  });
  _push(`<!--]--></ul></div><div class="return-call__error" data-v-e15092f0>${ssrInterpolate($data.invalidInputMessages.service_id)}</div></div><div class="return-call__field" data-v-e15092f0><div class="${ssrRenderClass([{ gray: !$data.formData.city_id }, "return-call__input"])}" data-v-e15092f0>${ssrInterpolate($options.cityChosen)} <img${ssrRenderAttr("src", _imports_0)} class="${ssrRenderClass({ rotated: $data.branchOptionsShown })}" alt="" data-v-e15092f0><ul class="${ssrRenderClass([{ options_shown: $data.branchOptionsShown }, "return-call__options branch_options"])}" data-v-e15092f0><!--[-->`);
  ssrRenderList($options.citiesIDs, (cityID, key) => {
    _push(`<li data-v-e15092f0>${ssrInterpolate($options.cities[cityID])}</li>`);
  });
  _push(`<!--]--></ul></div><div class="return-call__error" data-v-e15092f0>${ssrInterpolate($data.invalidInputMessages.city_id)}</div></div><div class="return-call__field" data-v-e15092f0><input class="return-call__input"${ssrRenderAttr("placeholder", _ctx.$texts.name)}${ssrRenderAttr("value", $data.formData.full_name)} data-v-e15092f0><div class="return-call__error" data-v-e15092f0>${ssrInterpolate($data.invalidInputMessages.full_name)}</div></div><div class="return-call__field" data-v-e15092f0><input${ssrRenderAttrs(mergeProps({
    class: "return-call__input",
    placeholder: _ctx.$texts.phoneNumber,
    "data-maska": "+7 ### ###-##-##",
    "data-maska-eager": "",
    value: $data.formData.phone
  }, ssrGetDirectiveProps(_ctx, _directive_maska)))} data-v-e15092f0><div class="return-call__error" data-v-e15092f0>${ssrInterpolate($data.invalidInputMessages.phone)}</div></div></div><div class="return-call__bottom" data-v-e15092f0><button class="return-call__send animate-red" data-v-e15092f0>${ssrInterpolate($props.sumbitBtnText)}</button><p data-v-e15092f0> \u041D\u0430\u0436\u0438\u043C\u0430\u044F \u043A\u043D\u043E\u043F\u043A\u0443, \u0412\u044B \u043F\u0440\u0438\u043D\u0438\u043C\u0430\u0435\u0442\u0435 \u0443\u0441\u043B\u043E\u0432\u0438\u044F <br class="tablet-only" data-v-e15092f0>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`\u043F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u0435\u043B\u044C\u0441\u043A\u043E\u0433\u043E <br class="desktop-only" data-v-e15092f0${_scopeId}> \u0441\u043E\u0433\u043B\u0430\u0448\u0435\u043D\u0438\u044F `);
      } else {
        return [
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-e15092f0"]]);

export { __nuxt_component_0 as _, __nuxt_component_0$1 as a };
//# sourceMappingURL=ReturnCallForm-5425227a.mjs.map
