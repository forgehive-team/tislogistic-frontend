...
import { _ as _export_sfc, i as useRuntimeConfig, b as useRouter, a as useHead, d as useSchemaOrg, k as defineWebSite, l as defineWebPage, f as useRoute, u as useNuxtApp } from '../server.mjs';
import { useSSRContext, defineComponent, computed, mergeProps, unref, withCtx, createVNode, reactive, createTextVNode, toDisplayString, resolveComponent, openBlock, createBlock, Fragment, renderList } from 'vue';
import { t as titleCase, u as useServerHead, c as createInternalLinkResolver, r as resolveAbsoluteInternalLink } from './internalLinks-4b44e090.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrIncludeBooleanAttr, ssrRenderSlot, ssrLooseContain, ssrRenderAttr, ssrRenderClass, ssrInterpolate, ssrRenderList } from 'vue/server-renderer';
import { _ as __nuxt_component_0$1 } from './nuxt-link-0d39ff03.mjs';
import { _ as __nuxt_component_1$1 } from './ExpandArrow-c1187625.mjs';
import { b as useTheme, a as useReturnCallModal, c as useSuccessModal, u as useCalculatorPopup } from './state-06d22502.mjs';
import { _ as __nuxt_component_1$3 } from './CompanyLogo-fae8444b.mjs';
import { Collapse } from 'vue-collapsed';
import { s as servicesList } from './servicesList-30883593.mjs';
import { _ as __nuxt_component_0$2, a as __nuxt_component_0$1$1 } from './ReturnCallForm-d086548f.mjs';
import { _ as __nuxt_component_1$2 } from './DeliveryCalculator-22efe5b0.mjs';
...
const _imports_0$3 = "" + buildAssetsURL("sun.6778997c.svg");
const _imports_1$2 = "" + buildAssetsURL("moon.4bc1f6d3.svg");
const _sfc_main$a = {
  __name: "ThemeSwitch",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<label class="switch dummy" data-v-3c3ffe96${_scopeId}><input${ssrIncludeBooleanAttr(isRus) ? " checked" : ""} type="checkbox" data-v-3c3ffe96${_scopeId}><span class="slider round" data-v-3c3ffe96${_scopeId}></span><span class="sun lang-name" data-v-3c3ffe96${_scopeId}>Ru</span><span class="moon lang-name" data-v-3c3ffe96${_scopeId}>En</span></label>`);
          } else {
            return [
...
const __nuxt_component_3$1 = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-3c3ffe96"]]);
const _sfc_main$8 = {};
...
const _imports_0$2 = "" + buildAssetsURL("close.e501a77d.svg");
const _sfc_main$7 = {
  components: {
    Collapse
  },
...
function _sfc_ssrRender$7(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_NuxtLink = __nuxt_component_0$1;
  const _component_IconsCompanyLogo = __nuxt_component_1$3;
  ...
  const _component_IconsExpandArrow = __nuxt_component_1$1;
  const _component_Collapse = resolveComponent("Collapse");
  _push(`<aside${ssrRenderAttrs(mergeProps({ class: "sidebar mobile-tablet-only" }, _attrs))} data-v-38023ddf><div class="sidebar__container" data-v-38023ddf><div class="sidebar__top" data-v-38023ddf>`);
  ...
  _push(`<button class="sidebar__close" data-v-38023ddf><img${ssrRenderAttr("src", _imports_0$2)}${ssrRenderAttr("alt", _ctx.$texts.close)} data-v-38023ddf></button></div><div class="sidebar__theme-container" data-v-38023ddf>`);
  ...
  _push(`</div><div class="sidebar__contacts" data-v-38023ddf><a${ssrRenderAttr("href", `tel:${_ctx.$texts.companyPhone}`)} data-v-38023ddf>`);
  _push(ssrRenderComponent(_component_IconsPhoneIcon, null, null, _parent));
  _push(` ${ssrInterpolate(_ctx.$texts.companyPhone)}</a></div><div class="sidebar__buttons" data-v-38023ddf><button class="navbar__btn navbar__btn_red sidebar__btn" data-v-38023ddf>${ssrInterpolate(_ctx.$texts.calculateDelivery)}</button><button class="navbar__btn sidebar__btn" data-v-38023ddf>${ssrInterpolate(_ctx.$texts.returnCall)}</button></div><div class="sidebar__links" data-v-38023ddf>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: "/about",
    class: "sidebar__link",
    onClick: $props.toggleSidebar
  ...
  _push(`<div data-v-38023ddf><div class="sidebar__services-link" data-v-38023ddf>`);
  ...
  _push(ssrRenderComponent(_component_Collapse, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="sidebar__services-list" data-v-38023ddf${_scopeId}><!--[-->`);
  ...
  _push(`<!--]--></div><div class="sidebar__links sidebar__links_secondary" data-v-38023ddf><a href="/traffic" class="vessels" data-v-38023ddf>${ssrInterpolate(_ctx.$texts.vesselsPosition)}</a><!--[-->`);
...
const __nuxt_component_4$1 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["ssrRender", _sfc_ssrRender$7], ["__scopeId", "data-v-38023ddf"]]);
const _imports_0$1 = "" + buildAssetsURL("logoBlack.445f085f.svg");
const _imports_1$1 = "" + buildAssetsURL("bars.fdd7c7de.svg");
const _sfc_main$6 = {
  setup() {
    const calculatorPopupShown = useCalculatorPopup();
    const returnCallShown = useReturnCallModal();
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_IconsClosePopup = __nuxt_component_0$1$1;
  const _component_SharedDeliveryCalculator = __nuxt_component_1$2;
...
const _imports_0 = "" + buildAssetsURL("logo-yellow-red.efbf8528.svg");
const _imports_1 = "" + buildAssetsURL("rhino.858bfab7.svg");
const _sfc_main$1 = {
  computed: {
    texts() {
      const { $texts } = useNuxtApp();
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_NuxtLink = __nuxt_component_0$1;
  const _component_IconsCompanyLogo = __nuxt_component_1$3;
  _push(`<footer${ssrRenderAttrs(mergeProps({ class: "footer" }, _attrs))} data-v-a09f27b4><div class="footer__container" data-v-a09f27b4>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(`<img${ssrRenderAttr("src", _imports_0)}${ssrRenderAttr("alt", _ctx.$texts.companyNameSeo)} data-v-a09f27b4${_scopeId}>`);
      } else {
        return [
          createVNode(_component_IconsCompanyLogo),
          createVNode("img", {
  ...
  _push(`<div class="footer__nav-links" data-v-a09f27b4><!--[-->`);
  ...
  _push(`<!--]--></div><div class="footer__info footer__info_left" data-v-a09f27b4><!--[-->`);
  ...
  _push(`<!--]--><a href="/traffic" class="vessels" data-v-a09f27b4>${ssrInterpolate(_ctx.$texts.vesselsPosition)}</a></div><div class="footer__info footer__info_right" data-v-a09f27b4><!--[-->`);
  ...
  _push(`<!--]--></div><div class="footer__branch-info phone-block" data-v-a09f27b4><span data-v-a09f27b4>${ssrInterpolate(_ctx.$texts.phone)}</span><a${ssrRenderAttr("href", $options.phoneRef)} data-v-a09f27b4>${ssrInterpolate(_ctx.$texts.companyPhone)}</a></div><div class="desktop-placeholder" data-v-a09f27b4></div><img class="footer__bg"${ssrRenderAttr("src", _imports_1)} alt="" data-v-a09f27b4></div><div class="footer__bottom" data-v-a09f27b4>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
  ...
  _push(`<div class="placeholder" data-v-a09f27b4></div>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    class: "agreement",
    to: "/eula"
  }, {
  ...
  _push(`<span class="copyright" data-v-a09f27b4>${ssrInterpolate(_ctx.$texts.footerNote)}</span></div></footer>`);
}
...
const __nuxt_component_5 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-a09f27b4"]]);
const _sfc_main = {
  setup() {
    const isWhiteTheme = useTheme();
    useHead({
      script: [
        {
          children: "(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src='https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);})(window,document,'script','dataLayer','GTM-59B7F22B');"
        }
      ],
      noscript: [
        {
          tagPosition: "bodyOpen",
          innerHTML: '<iframe src="https://www.googletagmanager.com/ns.html?id=GTM-59B7F22B"height="0" width="0" style="display:none;visibility:hidden"></iframe>'
        }
      ],
      bodyAttrs: {
        class: computed(() => {
...
//# sourceMappingURL=default-075d32ea.mjs.map
