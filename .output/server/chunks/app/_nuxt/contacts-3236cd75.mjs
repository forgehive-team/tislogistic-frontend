import { _ as __nuxt_component_0$2 } from './BreadCrumbs-c74601ed.mjs';
import { Swiper, SwiperSlide } from 'swiper/vue';
import { useSSRContext, ref, computed, toRaw, unref, mergeProps, withCtx, createVNode, toDisplayString, openBlock, createBlock, Fragment, renderList, onMounted, createCommentVNode, createTextVNode, defineComponent, createElementBlock } from 'vue';
...
import { _ as __nuxt_component_0$3 } from './LinkUnderline-05508d8a.mjs';
import { _ as __nuxt_component_0$4 } from './nuxt-img-6da1c54a.mjs';
import { _ as __nuxt_component_1$1 } from './DeliveryCalculator-ef5e9098.mjs';
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-cf09861b"]]);
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_HomeLinkUnderline = __nuxt_component_0$3;
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_ContactsCitySlider = __nuxt_component_1;
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-27a752d0><section data-v-27a752d0><div class="bg white-theme-only gradient-bg" data-v-27a752d0></div>`);
      _push(ssrRenderComponent(_component_SharedBreadCrumbs, { class: "breadcrumbs" }, null, _parent));
      _push(`<h1 data-v-27a752d0>${ssrInterpolate(unref($texts).contacts)}</h1></section><section class="city-slider" data-v-27a752d0>`);
      ...
      _push(`</section><section class="branch-info" data-v-27a752d0>`);
      if (unref(activeCity)) {
      ...
      if (unref(activeCity) && unref(activeCity).is_major_branch) {
        _push(`<section data-v-27a752d0><h2 data-v-27a752d0>${ssrInterpolate(unref($texts).companyAdministration)}</h2>`);
        ...
        _push(`<section class="administration" data-v-27a752d0>`);
      ...
      _push(`<section data-v-27a752d0>`);
      _push(ssrRenderComponent(_component_ContactsTelegramChannel, null, null, _parent));
      _push(`</section><section data-v-27a752d0><div class="calculator__back-blur" data-v-27a752d0>`);
...
const contacts = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-27a752d0"]]);

export { contacts as default };
//# sourceMappingURL=contacts-3236cd75.mjs.map
