...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-81c6b686><section data-v-81c6b686><div class="bg white-theme-only gradient-bg" data-v-81c6b686></div>`);
      _push(ssrRenderComponent(_component_SharedBreadCrumbs, { class: "breadcrumbs" }, null, _parent));
      _push(`<h1 data-v-81c6b686>${ssrInterpolate(unref($texts).contacts)}</h1></section><section class="city-slider" data-v-81c6b686>`);
      ...
      _push(`</section><section class="branch-info" data-v-81c6b686>`);
      if (unref(activeCity)) {
      ...
      if (unref(activeCity) && unref(activeCity).is_major_branch) {
        _push(`<section data-v-81c6b686><h2 data-v-81c6b686>${ssrInterpolate(unref($texts).companyAdministration)}</h2>`);
        ...
        _push(`<section class="administration" data-v-81c6b686>`);
      ...
      _push(`<section data-v-81c6b686>`);
      _push(ssrRenderComponent(_component_ContactsTelegramChannel, null, null, _parent));
      _push(`</section><section data-v-81c6b686><div class="calculator__back-blur" data-v-81c6b686>`);
...
const contacts = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-81c6b686"]]);

export { contacts as default };
//# sourceMappingURL=contacts-24fc1e35.mjs.map
