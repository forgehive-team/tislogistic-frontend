...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "calculator__input-container select_container" }, _attrs))} data-v-964a3069><div class="${ssrRenderClass([{ gray: !$props.formData.city_id }, "calculator__select"])}" data-v-964a3069>${ssrInterpolate($options.cityChosen)} <img${ssrRenderAttr("src", _imports_0$1)} class="${ssrRenderClass({ rotated: $data.cityOptionsShown })}" alt="" data-v-964a3069>`);
  if ($data.cityOptionsShown) {
    _push(`<ul class="calculator__options" data-v-964a3069><!--[-->`);
    ssrRenderList($options.citiesIDs, (cityID, key) => {
      _push(`<li data-v-964a3069>${ssrInterpolate($options.cities[cityID])}</li>`);
    });
    _push(`<!--]--></ul>`);
  } else {
    _push(`<!---->`);
  }
  _push(`</div><label class="calculator__input-label" data-v-964a3069>\u0424\u0438\u043B\u0438\u0430\u043B</label>`);
  if ($props.invalidInputMessages.city_id) {
    _push(`<div class="calculator__error-message" data-v-964a3069>${ssrInterpolate($props.invalidInputMessages.city_id)}</div>`);
  } else {
    _push(`<!---->`);
  }
  _push(`</div>`);
...
const __nuxt_component_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$3], ["__scopeId", "data-v-964a3069"]]);
...
//# sourceMappingURL=DeliveryCalculator-ef5e9098.mjs.map
