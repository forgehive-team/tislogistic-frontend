...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "presentation" }, _attrs))} data-v-d921ea95><div class="presentation__content" data-v-d921ea95><h2 class="presentation__title" data-v-d921ea95>${ssrInterpolate(_ctx.$texts.presentationTitle)}</h2><p class="presentation__text" data-v-d921ea95>${ssrInterpolate(_ctx.$texts.presentationDescription)}</p><div class="btns-container" data-v-d921ea95><div class="input-container" data-v-d921ea95>`);
      _push(ssrRenderComponent(_component_IconsEmailIcon, null, null, _parent));
      _push(`<input${ssrRenderAttr("value", unref(email))}${ssrRenderAttr("placeholder", _ctx.$texts.email)} data-v-d921ea95></div><button data-v-d921ea95> Send `);
      _push(ssrRenderComponent(_component_IconsArrowRight, null, null, _parent));
      _push(`</button></div><p class="error" data-v-d921ea95>${ssrInterpolate(unref(errorMessage))}</p></div>`);
...
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d921ea95"]]);

export { __nuxt_component_3 as _ };
//# sourceMappingURL=CompanyPresentation-c67bf544.mjs.map
