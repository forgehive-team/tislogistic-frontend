import { _ as __nuxt_component_0 } from './NewsPage-08b806e9.mjs';
...
import 'ufo';
import 'swiper/vue';
import './SwiperControls-8bb386b1.mjs';
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    useHead({
      title: () => (data == null ? void 0 : data.value) ? data.value.title : "Projects"
    });
    useServerHead({});
...
//# sourceMappingURL=_slug_-a1ad75d7.mjs.map
