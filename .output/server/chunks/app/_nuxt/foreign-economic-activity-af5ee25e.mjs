...
import { _ as __nuxt_component_1$2 } from './ServicesLinks-b725e6d3.mjs';
...
const services = [
  "Counseling clients \non how to circumvent sanctions restrictions.",
  "Calculation of customs duties \nand taxes payable to customs.",
  "Complete pre-clearance \nfor customs clearance.",
  "Preparation and submission \nof customs declarations and control of customs clearance.",
  "Commodity nomenclature \nof foreign economic activity code matching.",
  "Supporting customs procedures \nand representing clients before customs authorities.",
  "Help with foreign trade contracts.",
  "Support of court disputes \nwith customs authorities in civil and administrative cases.",
...
const list = [
  {
    label: "Providing the opportunity to lend on favorable terms without unnecessary documents for regular customers",
    img: imgBasePath + "credit.svg"
  },
  {
    label: "Acquisition of goods in any international market, including parallel imports*",
    img: imgBasePath + "any_market.svg"
  },
  {
    label: "Full customs clearance in both the sending and receiving countries ",
    img: imgBasePath + "custom_clearance.svg"
  },
  {
    label: "Bypassing international sanctions",
...
const _sfc_main = {
  __name: "foreign-economic-activity",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-272378db><section data-v-272378db><div style="${ssrRenderStyle(bgImg)}" class="bg foreign-bg" data-v-272378db></div>`);
      ...
      _push(`</section><section id="scroll-target" data-v-272378db>`);
      _push(ssrRenderComponent(_component_ForeignServices, null, null, _parent));
      _push(`</section><section data-v-272378db>`);
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/services/foreign-economic-activity.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const foreignEconomicActivity = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-272378db"]]);

export { foreignEconomicActivity as default };
//# sourceMappingURL=foreign-economic-activity-af5ee25e.mjs.map
