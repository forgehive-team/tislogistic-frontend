...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)} data-v-b557a517><section class="services-header" data-v-b557a517><div class="bg gradient-bg white-theme-only services-bg" data-v-b557a517></div>`);
  _push(ssrRenderComponent(_component_ServicesMainHeader, null, null, _parent));
  _push(`</section><section class="services-main" data-v-b557a517><h2 class="services-list__title" data-v-b557a517>${ssrInterpolate(_ctx.$texts.mainServices)}</h2>`);
  ...
  _push(`</section><section class="services-extra" data-v-b557a517><h2 class="services-list__title" data-v-b557a517>${ssrInterpolate(_ctx.$texts.additionalServices)}</h2>`);
  _push(ssrRenderComponent(_component_SharedServicesCards, {
    class: "services-cards_services-page services-cards_additional-services",
    "services-list": $options.additionalServices
  }, null, _parent));
  _push(`</section><section class="services-card" data-v-b557a517>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-b557a517"]]);

export { index as default };
//# sourceMappingURL=index-e50a4ffc.mjs.map
