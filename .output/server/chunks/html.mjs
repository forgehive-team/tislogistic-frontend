...
import { defineHeadPlugin, resolveTitleTemplate, hashTag, hashCode, tagDedupeKey, ValidHeadTags, asArray, TagConfigKeys, TagsWithInnerContent } from '@unhead/shared';
import 'node:fs';
import 'pathe';
